...
describe('Testing endpoints for purchasing', () => {
    describe('should get all purchasing', () => {
        it('responds with json', async () => {
            const response = await (0, supertest_1.default)(__1.default).get('/purchasing').set('Accept', 'application/json');
    ...
    describe('GET /purchasing/:id', () => {
        it('should get user by ID', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/purchasing/${Id}`);
            expect(response.status).toBe(200);
        ...
        it('should return 404 if user is not found', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/purchasing/${nonExistingUserId}`);
