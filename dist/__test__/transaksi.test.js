...
describe('Testing endpoints for transaksi', () => {
    describe('should get all transaksi', () => {
        it('responds with json', async () => {
            const response = await (0, supertest_1.default)(__1.default).get('/transaksi').set('Accept', 'application/json');
    ...
    describe('GET /transaksi/:id', () => {
        it('should get user by ID', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/transaksi/${Id}`);
            expect(response.status).toBe(200);
        ...
        it('should return 404 if user is not found', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/transaksi/${nonExistingUserId}`);
