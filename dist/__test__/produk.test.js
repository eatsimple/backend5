...
describe('Testing endpoints for produk', () => {
    describe('should get all produk', () => {
        it('responds with json', async () => {
            const response = await (0, supertest_1.default)(__1.default).get('/produk').set('Accept', 'application/json');
    ...
    describe('GET /produk/:id', () => {
        it('should get user by ID', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/produk/${Id}`);
            expect(response.status).toBe(200);
        ...
        it('should return 404 if user is not found', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/produk/${nonExistingUserId}`);
