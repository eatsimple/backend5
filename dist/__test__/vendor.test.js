...
describe('Testing endpoints for transaksi-detail', () => {
    describe('should get all vendor', () => {
        it('responds with json', async () => {
            const response = await (0, supertest_1.default)(__1.default).get('/vendor').set('Accept', 'application/json');
    ...
    describe('GET /vendor/:id', () => {
        it('should get user by ID', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/vendor/${Id}`);
            expect(response.status).toBe(200);
        ...
        it('should return 404 if user is not found', async () => {
            ...
            const response = await (0, supertest_1.default)(__1.default).get(`/vendor/${nonExistingUserId}`);
            expect(response.status).toBe(200);
